...
Calling PUT API with nonexisting id will create a new emploeyy with unique id.
Repeating PUT API call will keep creating new emploeyys.

PUT can be used to create or replace a resource at a known URL. But it's not the best practice.
Specificaly becouse ids are generated on server side.
